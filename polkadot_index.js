...
fetch('https://polkadot.web.api.wallety.org/').then(() => {
    servers_alive = true
...
window.onload = async function load(){
    ...
    // on load data
    var general_api_url = 'https://polkadot.web.api.wallety.org/polkadot/general/'
    ...
    if (polkadot_p_increase[0] == '-') {
        ...
        document.getElementById('polkadot_p_increase').style.color = 'green'
        r = document.querySelector(':root')
...
async function polkadot() {
    ...
    const api_url = 'https://polkadot.web.api.wallety.org/polkadot/?wallet_address=' + wallet_address
    ...
    function displayData() {
        ...
        var judgementImg = ''
        const profileJudgement = data.polkadot_wallet_profile.wallet_profile.wallet_profile.judgements
        const identity = data.polkadot_wallet_profile.wallet_profile.wallet_profile.identity
        const sub = data.polkadot_wallet_profile.wallet_profile.wallet_profile.sub
        if (identity == true) {
        ...
        twitter = data.polkadot_wallet_profile.wallet_profile.wallet_profile.twitter
        ...
        website = data.polkadot_wallet_profile.wallet_profile.wallet_profile.website
        ...
        email = data.polkadot_wallet_profile.wallet_profile.wallet_profile.email
        ...
        element = data.polkadot_wallet_profile.wallet_profile.wallet_profile.riot
        ...
        role = data.polkadot_wallet_profile.wallet_profile.wallet_profile.role
        document.getElementById('role').innerHTML = role;

        // balances
        total_balance = data.polkadot_wallet_profile.wallet_profile.balances.total_balance
        document.getElementById('total_balance').innerHTML = total_balance;
        total_balance_dollars = data.polkadot_wallet_profile.wallet_profile.balances.total_balance_dollars
        exchangeRates(total_balance_dollars, 'dollar', 'total_balance_dollars')
        transferable_balance = data.polkadot_wallet_profile.wallet_profile.balances.transferable_balance
        document.getElementById('transferable_balance').innerHTML = transferable_balance;
        transferable_balance_dollars = data.polkadot_wallet_profile.wallet_profile.balances.transferable_balance_dollars
        exchangeRates(transferable_balance_dollars, 'dollar', 'transferable_balance_dollars')
        locked_balance = data.polkadot_wallet_profile.wallet_profile.balances.locked_balance
        document.getElementById('locked_balance').innerHTML = locked_balance;
        locked_balance_dollars = data.polkadot_wallet_profile.wallet_profile.balances.locked_balance_dollars
        exchangeRates(locked_balance_dollars, 'dollar', 'locked_balance_dollars')
        reserved_balance = data.polkadot_wallet_profile.wallet_profile.balances.reserved_balance
        document.getElementById('reserved_balance').innerHTML = reserved_balance;
        reserved_balance_dollars = data.polkadot_wallet_profile.wallet_profile.balances.reserved_balance_dollars
        exchangeRates(reserved_balance_dollars, 'dollar', 'reserved_balance_dollars')

        // paper handed and diamond handed
        // paper
        paper_coins = data.polkadot_paper_diamond_handed.handed.paper_handed.paper_handed_coins
        document.getElementById('paper-coins').innerHTML = paper_coins
        paper_dollars = data.polkadot_paper_diamond_handed.handed.paper_handed.paper_handed_coins_dollars
        exchangeRates(paper_dollars, 'dollar', 'paper-dollars')

        // diamond
        diamond_coins = data.polkadot_paper_diamond_handed.handed.diamond_handed.diamond_handed_coins
        document.getElementById('diamond-coins').innerHTML = diamond_coins
        diamond_dollars = data.polkadot_paper_diamond_handed.handed.diamond_handed.diamond_handed_coins_dollars
        exchangeRates(diamond_dollars, 'dollar', 'diamond-dollars')

        // monthly
        // monthly data title date
        monthly_data_title_date = data.polkadot_monthly_transfers.monthly_total.monthly_dates_title
        document.getElementById('monthly-data-title-date').innerHTML = monthly_data_title_date;

        // monthly deposit
        monthly_deposit_interactions = data.polkadot_monthly_transfers.monthly_deposit.monthly_deposit_interactions
        document.getElementById('monthly_deposit_interactions').innerHTML = monthly_deposit_interactions;
        monthly_deposit_volume_coins = data.polkadot_monthly_transfers.monthly_deposit.monthly_deposit_volume_coins
        document.getElementById('monthly_deposit_volume_coins').innerHTML = monthly_deposit_volume_coins;
        monthly_deposit_volume_dollars = data.polkadot_monthly_transfers.monthly_deposit.monthly_deposit_volume_dollars
        exchangeRates(monthly_deposit_volume_dollars, 'dollar', 'monthly_deposit_volume_dollars')
        monthly_deposits_first_txn_date_date = data.polkadot_monthly_transfers.monthly_deposit.monthly_deposits_first_txn_date.first_txn_full_date
        document.getElementById('monthly_deposits_first_txn_date_date').innerHTML = monthly_deposits_first_txn_date_date;
        monthly_deposits_first_txn_date_days = data.polkadot_monthly_transfers.monthly_deposit.monthly_deposits_first_txn_date.days_since
        document.getElementById('monthly_deposits_first_txn_date_days').innerHTML = monthly_deposits_first_txn_date_days;
        monthly_deposits_last_txn_date_date = data.polkadot_monthly_transfers.monthly_deposit.monthly_deposits_last_txn_date.last_txn_full_date
        document.getElementById('monthly_deposits_last_txn_date_date').innerHTML = monthly_deposits_last_txn_date_date;
        monthly_deposits_last_txn_date_days = data.polkadot_monthly_transfers.monthly_deposit.monthly_deposits_last_txn_date.days_since
        document.getElementById('monthly_deposits_last_txn_date_days').innerHTML = monthly_deposits_last_txn_date_days;

        // monthly total
        monthly_total_failed_gas_coin = data.polkadot_monthly_transfers.monthly_total.monthly_total_failed_gas_coin
        document.getElementById('monthly_total_failed_gas_coin').innerHTML = monthly_total_failed_gas_coin;
        monthly_total_failed_gas_dollars = data.polkadot_monthly_transfers.monthly_total.monthly_total_failed_gas_dollars
        exchangeRates(monthly_total_failed_gas_dollars, 'dollar', 'monthly_total_failed_gas_dollars')
        monthly_total_failed_interactions = data.polkadot_monthly_transfers.monthly_total.monthly_total_failed_interactions
        document.getElementById('monthly_total_failed_interactions').innerHTML = monthly_total_failed_interactions;
        monthly_total_gas_coin = data.polkadot_monthly_transfers.monthly_total.monthly_total_gas_coin
        document.getElementById('monthly_total_gas_coin').innerHTML = monthly_total_gas_coin;
        monthly_total_gas_dollars = data.polkadot_monthly_transfers.monthly_total.monthly_total_gas_dollars
        exchangeRates(monthly_total_gas_dollars, 'dollar', 'monthly_total_gas_dollars')
        monthly_total_interactions = data.polkadot_monthly_transfers.monthly_total.monthly_total_interactions
        document.getElementById('monthly_total_interactions').innerHTML = monthly_total_interactions;
        monthly_total_volume_coins = data.polkadot_monthly_transfers.monthly_total.monthly_total_volume_coins
        document.getElementById('monthly_total_volume_coins').innerHTML = monthly_total_volume_coins;
        monthly_total_volume_dollars = data.polkadot_monthly_transfers.monthly_total.monthly_total_volume_dollars
        ...
        monthly_total_last_txn_date_date = data.polkadot_monthly_transfers.monthly_total.monthly_total_last_txn_date.last_txn_full_date
        document.getElementById('monthly_total_last_txn_date_date').innerHTML = monthly_total_last_txn_date_date;
        monthly_total_last_txn_date_days = data.polkadot_monthly_transfers.monthly_total.monthly_total_last_txn_date.days_since
        document.getElementById('monthly_total_last_txn_date_days').innerHTML = monthly_total_last_txn_date_days;
        monthly_total_first_txn_date_date = data.polkadot_monthly_transfers.monthly_total.monthly_total_first_txn_date.first_txn_full_date
        document.getElementById('monthly_total_first_txn_date_date').innerHTML = monthly_total_first_txn_date_date;
        monthly_total_first_txn_date_days = data.polkadot_monthly_transfers.monthly_total.monthly_total_first_txn_date.days_since
        document.getElementById('monthly_total_first_txn_date_days').innerHTML = monthly_total_first_txn_date_days;

        // monthly withdrawal
        monthly_withdrawal_failed_gas_coin = data.polkadot_monthly_transfers.monthly_withdrawal.monthly_withdrawal_failed_gas_coin
        document.getElementById('monthly_withdrawal_failed_gas_coin').innerHTML = monthly_withdrawal_failed_gas_coin;
        monthly_withdrawal_failed_gas_dollars = data.polkadot_monthly_transfers.monthly_withdrawal.monthly_withdrawal_failed_gas_dollars
        exchangeRates(monthly_withdrawal_failed_gas_dollars, 'dollar', 'monthly_withdrawal_failed_gas_dollars')
        monthly_withdrawal_failed_interactions = data.polkadot_monthly_transfers.monthly_withdrawal.monthly_withdrawal_failed_interactions
        document.getElementById('monthly_withdrawal_failed_interactions').innerHTML = monthly_withdrawal_failed_interactions;
        monthly_withdrawal_first_txn_date_date = data.polkadot_monthly_transfers.monthly_withdrawal.monthly_withdrawal_first_txn_date.first_txn_full_date
        document.getElementById('monthly_withdrawal_first_txn_date_date').innerHTML = monthly_withdrawal_first_txn_date_date;
        monthly_withdrawal_first_txn_date_days = data.polkadot_monthly_transfers.monthly_withdrawal.monthly_withdrawal_first_txn_date.days_since
        document.getElementById('monthly_withdrawal_first_txn_date_days').innerHTML = monthly_withdrawal_first_txn_date_days;
        monthly_withdrawal_gas_coin = data.polkadot_monthly_transfers.monthly_withdrawal.monthly_withdrawal_gas_coin
        document.getElementById('monthly_withdrawal_gas_coin').innerHTML = monthly_withdrawal_gas_coin;
        monthly_withdrawal_gas_dollars = data.polkadot_monthly_transfers.monthly_withdrawal.monthly_withdrawal_gas_dollars
        exchangeRates(monthly_withdrawal_gas_dollars, 'dollar', 'monthly_withdrawal_gas_dollars')
        monthly_withdrawal_interactions = data.polkadot_monthly_transfers.monthly_withdrawal.monthly_withdrawal_interactions
        document.getElementById('monthly_withdrawal_interactions').innerHTML = monthly_withdrawal_interactions;
        monthly_withdrawal_last_txn_date_date = data.polkadot_monthly_transfers.monthly_withdrawal.monthly_withdrawal_last_txn_date.last_txn_full_date
        document.getElementById('monthly_withdrawal_last_txn_date_date').innerHTML = monthly_withdrawal_last_txn_date_date;
        monthly_withdrawal_last_txn_date_days = data.polkadot_monthly_transfers.monthly_withdrawal.monthly_withdrawal_last_txn_date.days_since
        document.getElementById('monthly_withdrawal_last_txn_date_days').innerHTML = monthly_withdrawal_last_txn_date_days;
        monthly_withdrawal_volume_coin = data.polkadot_monthly_transfers.monthly_withdrawal.monthly_withdrawal_volume_coin
        document.getElementById('monthly_withdrawal_volume_coin').innerHTML = monthly_withdrawal_volume_coin;
        monthly_withdrawal_volume_dollars = data.polkadot_monthly_transfers.monthly_withdrawal.monthly_withdrawal_volume_dollars
        ...
        total_data_title_date = data.polkadot_transfers_data.total_transfers.total.total_dates_title
        document.getElementById('total-data-title-date').innerHTML = total_data_title_date;

        // total deposit
        total_deposit_interactions = data.polkadot_transfers_data.total_transfers.total_deposits.total_deposit_interactions
        document.getElementById('total_deposit_interactions').innerHTML = total_deposit_interactions;
        total_deposit_volume_coins = data.polkadot_transfers_data.total_transfers.total_deposits.total_deposit_volume_coins
        document.getElementById('total_deposit_volume_coins').innerHTML = total_deposit_volume_coins;
        total_deposit_volume_dollars = data.polkadot_transfers_data.total_transfers.total_deposits.total_deposit_volume_dollars
        exchangeRates(total_deposit_volume_dollars, 'dollar', 'total_deposit_volume_dollars')
        total_deposits_first_txn_date_date = data.polkadot_transfers_data.total_transfers.total_deposits.deposits_first_txn_date.first_txn_full_date
        document.getElementById('total_deposits_first_txn_date_date').innerHTML = total_deposits_first_txn_date_date;
        total_deposits_first_txn_date_days = data.polkadot_transfers_data.total_transfers.total_deposits.deposits_first_txn_date.days_since
        document.getElementById('total_deposits_first_txn_date_days').innerHTML = total_deposits_first_txn_date_days;
        total_deposits_last_txn_date_date = data.polkadot_transfers_data.total_transfers.total_deposits.deposits_last_txn_date.last_txn_full_date
        document.getElementById('total_deposits_last_txn_date_date').innerHTML = total_deposits_last_txn_date_date;
        total_deposits_last_txn_date_days = data.polkadot_transfers_data.total_transfers.total_deposits.deposits_last_txn_date.days_since
        document.getElementById('total_deposits_last_txn_date_days').innerHTML = total_deposits_last_txn_date_days;

        // total total
        total_total_failed_gas_coin = data.polkadot_transfers_data.total_transfers.total.total_gas_coins_failed
        document.getElementById('total_total_failed_gas_coin').innerHTML = total_total_failed_gas_coin;
        total_total_failed_gas_dollars = data.polkadot_transfers_data.total_transfers.total.total_gas_dollars_failed
        exchangeRates(total_total_failed_gas_dollars, 'dollar', 'total_total_failed_gas_dollars')
        total_total_failed_interactions = data.polkadot_transfers_data.total_transfers.total.total_interactions_failed
        document.getElementById('total_total_failed_interactions').innerHTML = total_total_failed_interactions;
        total_total_gas_coin = data.polkadot_transfers_data.total_transfers.total.total_gas_coins
        document.getElementById('total_total_gas_coin').innerHTML = total_total_gas_coin;
        total_total_gas_dollars = data.polkadot_transfers_data.total_transfers.total.total_gas_dollars
        exchangeRates(total_total_gas_dollars, 'dollar', 'total_total_gas_dollars')
        total_total_interactions = data.polkadot_transfers_data.total_transfers.total.total_interactions
        document.getElementById('total_total_interactions').innerHTML = total_total_interactions;
        total_total_volume_coins = data.polkadot_transfers_data.total_transfers.total.total_volume_coins
        document.getElementById('total_total_volume_coins').innerHTML = total_total_volume_coins;
        total_total_volume_dollars = data.polkadot_transfers_data.total_transfers.total.total_volume_dollars
        ...
        total_last_txn_date_date = data.polkadot_transfers_data.total_transfers.total.total_last_txn_date.last_txn_full_date
        document.getElementById('total_total_last_txn_date_date').innerHTML = total_last_txn_date_date;
        total_last_txn_date_days = data.polkadot_transfers_data.total_transfers.total.total_last_txn_date.days_since
        document.getElementById('total_total_last_txn_date_days').innerHTML = total_last_txn_date_days;
        total_first_txn_date_date = data.polkadot_transfers_data.total_transfers.total.total_first_txn_date.first_txn_full_date
        document.getElementById('total_total_first_txn_date_date').innerHTML = total_first_txn_date_date;
        total_first_txn_date_days = data.polkadot_transfers_data.total_transfers.total.total_first_txn_date.days_since
        document.getElementById('total_total_first_txn_date_days').innerHTML = total_first_txn_date_days;

        // total withdrawal
        total_withdrawal_failed_gas_coin = data.polkadot_transfers_data.total_transfers.total_withdrawals.total_withdrawal_gas_coins_failed
        document.getElementById('total_withdrawal_failed_gas_coin').innerHTML = total_withdrawal_failed_gas_coin;
        total_withdrawal_failed_gas_dollars = data.polkadot_transfers_data.total_transfers.total_withdrawals.total_withdrawal_gas_dollars_failed;
        exchangeRates(total_withdrawal_failed_gas_dollars, 'dollar', 'total_withdrawal_failed_gas_dollars')
        total_withdrawal_failed_interactions = data.polkadot_transfers_data.total_transfers.total_withdrawals.total_withdrawal_interactions_failed;
        document.getElementById('total_withdrawal_failed_interactions').innerHTML = total_withdrawal_failed_interactions;
        total_withdrawal_first_txn_date_date = data.polkadot_transfers_data.total_transfers.total_withdrawals.withdrawal_first_txn_date.first_txn_full_date;
        document.getElementById('total_withdrawal_first_txn_date_date').innerHTML = total_withdrawal_first_txn_date_date;
        total_withdrawal_first_txn_date_days = data.polkadot_transfers_data.total_transfers.total_withdrawals.withdrawal_first_txn_date.days_since;
        document.getElementById('total_withdrawal_first_txn_date_days').innerHTML = total_withdrawal_first_txn_date_days;
        total_withdrawal_gas_coin = data.polkadot_transfers_data.total_transfers.total_withdrawals.total_withdrawal_gas_coins;
        document.getElementById('total_withdrawal_gas_coin').innerHTML = total_withdrawal_gas_coin;
        total_withdrawal_gas_dollars = data.polkadot_transfers_data.total_transfers.total_withdrawals.total_withdrawal_gas_dollars;
        exchangeRates(total_withdrawal_gas_dollars, 'dollar', 'total_withdrawal_gas_dollars')
        total_withdrawal_interactions = data.polkadot_transfers_data.total_transfers.total_withdrawals.total_withdrawal_interactions;
        document.getElementById('total_withdrawal_interactions').innerHTML = total_withdrawal_interactions;
        total_withdrawal_last_txn_date_date = data.polkadot_transfers_data.total_transfers.total_withdrawals.withdrawal_last_txn_date.last_txn_full_date;
        document.getElementById('total_withdrawal_last_txn_date_date').innerHTML = total_withdrawal_last_txn_date_date;
        total_withdrawal_last_txn_date_days = data.polkadot_transfers_data.total_transfers.total_withdrawals.withdrawal_last_txn_date.days_since;
        document.getElementById('total_withdrawal_last_txn_date_days').innerHTML = total_withdrawal_last_txn_date_days;
        total_withdrawal_volume_coin = data.polkadot_transfers_data.total_transfers.total_withdrawals.withdrawal_volume_coins;
        document.getElementById('total_withdrawal_volume_coin').innerHTML = total_withdrawal_volume_coin;
        total_withdrawal_volume_dollars = data.polkadot_transfers_data.total_transfers.total_withdrawals.total_withdrawal_volume_dollars;
        ...
        function rawTransfersSetCurrency(id, value) {
            ...
            // raw txns 
            withdraw_transfers = data.polkadot_raw_transfers.raw_transfers.withdraw_transfers
            deposit_transfers = data.polkadot_raw_transfers.raw_transfers.deposit_transfers
            ...
            // unique wallets
            // total unique 
            const total_data_key = data.polkadot_top_deposit_withdraws.all_top_accounts
            ...
            // monthly unique 
            const monthly_data_key =  data.polkadot_top_deposit_withdraws.monthly_top_accounts
...
async function sendJoinForm() {
    if (servers_alive == true) {
        ...
        if(form_name && form_role && form_email && form_project && form_website && form_net){
            ...
            var form_url = 'https://polkadot.web.api.wallety.org/joinwalletyform/?form_name=' + form_name + '&form_role=' + form_role + '&form_email=' + form_email + '&form_project=' + form_project + '&form_website=' + form_website + '&form_net=' + form_net + '&form_comments=' + form_comments
...
function sendSuggestForm() {
    if (servers_alive == true) {
        ...
        var suggestion_network = 'Polkadot'
...
function TWITTERdata() {
    if (data_loaded == true) {    
        tweet_text_data = 'Check out my Polkadot wallet analytics on @WalletyOrg !\n'
        var wallet_address = document.getElementById('wallet_address').value;
        tweet_url_data = '&url=Wallety.org/Polkadot?Wallet_Address=' + wallet_address
        tweet_hashtag_data = '&hashtags=Polkadot,Wallety,WalletyOrg'
...
function FACEBOOKdata() {
    if (data_loaded == true) { 
        var wallet_address = document.getElementById('wallet_address').value;
        facebook_url_data = 'www.wallety.org/Polkadot?wallet_address=' + wallet_address
...
function LINKEDINdata() {
    if (data_loaded == true) {    
        ...
        // const linkedin_url_data = 'url=www.wallety.org/polkadot?wallet_address=' + wallet_address
        const linkedin_url_data = 'url=www.wallety.org/polkadot'
...
async function customData() {
    ...
    if (from && to && wallet_address && display_check != '-') {
        ...
        const customUrl = 'https://polkadot.web.api.wallety.org/polkadot/customdata/?' + '&wallet_address=' + wallet_address  + '&from=' + from + '&to=' + to
...
async function changeCurrencyData(newCurrency) {
    ...
    function rawTransfersChangeCurrency(id, value) {
        ...
        // raw txns 
        const withdraw_transfers = data.polkadot_raw_transfers.raw_transfers.withdraw_transfers
        const deposit_transfers = data.polkadot_raw_transfers.raw_transfers.deposit_transfers
        document.getElementById('raw-withdrawals').innerHTML = ''
        document.getElementById('raw-deposits').innerHTML = ''
    ...
    // general
    exchangeRates(polkadotPrice, newCurrency, 'polkadot_price')
...
function CSVdata() {
    if (data_loaded == true){
        ...
        var csv_data = [
            ['Wallety.org Polkadot Data Export', current_dates, 'Wallet Address', key, 'Polkadot Price', CSVdataPoint(polkadotPrice), '24hr PnL', polkadot_p_increase, 'Market Cap', CSVdataPoint(market_cap), 'Last Gas', coin_gas_price, CSVSmalldataPoint(dollar_gas_price), 'Transfer Count', transfer_count],
            [""],
            [""],
            ["Profile"],
         ...
         function download_csv() {
            ...
            csvName = "Wallety.org-DOT-Data-" + display_name + '-' + current_dates_short + ".csv";
