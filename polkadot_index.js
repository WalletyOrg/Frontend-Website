...
function TWITTERdata() {
    if (data_loaded == true) {    
        ...
        var wallet_address = document.getElementById('wallet_address').value;
        tweet_url_data = '&url=Wallety.org/Polkadot.html?Wallet_Address=' + wallet_address
...
function FACEBOOKdata() {
    if (data_loaded == true) { 
        var wallet_address = document.getElementById('wallet_address').value;
        facebook_url_data = 'www.wallety.org/Polkadot.html?wallet_address=' + wallet_address
...
function LINKEDINdata() {
    if (data_loaded == true) {    
        var wallet_address = document.getElementById('wallet_address').value;
        linkedin_url_data = 'url=www.wallety.org/polkadot.html?wallet_address=' + wallet_address
